...
class BookTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'App.Modules.Auth.Model.Map.BookTableMap';
     ...
     */
    const OM_CLASS = '\\App\\Modules\\Auth\\Model\\Book';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'App.Modules.Auth.Model.Book';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\App\\Modules\\Auth\\Model\\Book');
    ...
    {
        $this->addRelation('Publisher', '\\App\\Modules\\Users\\Model\\Publisher', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':publisher_id',
    1 => ':id',
        ...
        $this->addRelation('Author', '\\App\\Modules\\Users\\Model\\Author', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':author_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\Modules\Auth\Model\Book) { // it's a model object
