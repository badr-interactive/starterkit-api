...
use App\Modules\Users\Model\AuthorQuery;
use App\Modules\Users\Model\Publisher;
use App\Modules\Users\Model\PublisherQuery;
...
abstract class Book implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Modules\\Auth\\Model\\Map\\BookTableMap';
    ...
    /**
     * Initializes internal state of App\Modules\Auth\Model\Base\Book object.
     */
     ...
     * @return $this|\App\Modules\Auth\Model\Book The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Modules\\Auth\\Model\\Book'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\Modules\Auth\Model\Book
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Modules\Auth\Model\Book The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\Modules\Auth\Model\Book (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Modules\Auth\Model\Book Clone of current object.
     * @throws PropelException
     */
