...
use \Exception;
use \PDO;
use App\Modules\Auth\Model\Book as ChildBook;
use App\Modules\Auth\Model\BookQuery as ChildBookQuery;
use App\Modules\Auth\Model\Map\BookTableMap;
use App\Modules\Users\Model\Author;
use App\Modules\Users\Model\Publisher;
 ...
 *
 * @method     \App\Modules\Users\Model\PublisherQuery|\App\Modules\Users\Model\AuthorQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class BookQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \App\Modules\Auth\Model\Base\BookQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'bookstore', $modelName = '\\App\\Modules\\Auth\\Model\\Book', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \App\Modules\Users\Model\Publisher object
     *
     * @param \App\Modules\Users\Model\Publisher|ObjectCollection $publisher The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($publisher instanceof \App\Modules\Users\Model\Publisher) {
            return $this
            ...
            throw new PropelException('filterByPublisher() only accepts arguments of type \App\Modules\Users\Model\Publisher or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \App\Modules\Users\Model\PublisherQuery A secondary query class using the current class as primary query
     */
    public function usePublisherQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinPublisher($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Publisher', '\App\Modules\Users\Model\PublisherQuery');
    }

    /**
     * Filter the query by a related \App\Modules\Users\Model\Author object
     *
     * @param \App\Modules\Users\Model\Author|ObjectCollection $author The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($author instanceof \App\Modules\Users\Model\Author) {
            return $this
            ...
            throw new PropelException('filterByAuthor() only accepts arguments of type \App\Modules\Users\Model\Author or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \App\Modules\Users\Model\AuthorQuery A secondary query class using the current class as primary query
     */
    public function useAuthorQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinAuthor($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Author', '\App\Modules\Users\Model\AuthorQuery');
    }
