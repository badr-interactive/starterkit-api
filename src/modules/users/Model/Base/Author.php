...
use App\Modules\Users\Model\Author as ChildAuthor;
use App\Modules\Users\Model\AuthorQuery as ChildAuthorQuery;
use App\Modules\Users\Model\Map\AuthorTableMap;
...
abstract class Author implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Modules\\Users\\Model\\Map\\AuthorTableMap';
    ...
    /**
     * Initializes internal state of App\Modules\Users\Model\Base\Author object.
     */
     ...
     * @return $this|\App\Modules\Users\Model\Author The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Modules\\Users\\Model\\Author'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\Modules\Users\Model\Author
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Modules\Users\Model\Author The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\Modules\Users\Model\Author (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Modules\Users\Model\Author Clone of current object.
     * @throws PropelException
     */
