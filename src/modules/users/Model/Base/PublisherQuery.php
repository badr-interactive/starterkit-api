 ...
 *
 * @method     \App\Modules\Auth\Model\BookQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class PublisherQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \App\Modules\Users\Model\Base\PublisherQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'bookstore', $modelName = '\\App\\Modules\\Users\\Model\\Publisher', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \App\Modules\Auth\Model\Book object
     *
     * @param \App\Modules\Auth\Model\Book|ObjectCollection $book the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
    ...
    {
        if ($book instanceof \App\Modules\Auth\Model\Book) {
            return $this
            ...
            throw new PropelException('filterByBook() only accepts arguments of type \App\Modules\Auth\Model\Book or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \App\Modules\Auth\Model\BookQuery A secondary query class using the current class as primary query
     */
    public function useBookQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinBook($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Book', '\App\Modules\Auth\Model\BookQuery');
    }
