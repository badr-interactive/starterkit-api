...
namespace App\Modules\Users\Model\Base;

use \Exception;
use \PDO;
use App\Modules\Auth\Model\Book;
use App\Modules\Auth\Model\BookQuery;
use App\Modules\Auth\Model\Base\Book as BaseBook;
use App\Modules\Auth\Model\Map\BookTableMap;
use App\Modules\Users\Model\Publisher as ChildPublisher;
use App\Modules\Users\Model\PublisherQuery as ChildPublisherQuery;
use App\Modules\Users\Model\Map\PublisherTableMap;
 ...
 *
 *
 * @package    propel.generator.App.Modules.Users.Model.Base
 */
abstract class Publisher implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Modules\\Users\\Model\\Map\\PublisherTableMap';
    ...
    /**
     * @var        ObjectCollection|Book[] Collection to store aggregation of Book objects.
     */
    protected $collBooks;
     ...
     * @var ObjectCollection|Book[]
     */
    protected $booksScheduledForDeletion = null;

    /**
     * Initializes internal state of App\Modules\Users\Model\Base\Publisher object.
     */
     ...
     * @return $this|\App\Modules\Users\Model\Publisher The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Modules\\Users\\Model\\Publisher'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->booksScheduledForDeletion !== null) {
                if (!$this->booksScheduledForDeletion->isEmpty()) {
                    \App\Modules\Auth\Model\BookQuery::create()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\Modules\Users\Model\Publisher
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Modules\Users\Model\Publisher The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\Modules\Users\Model\Publisher (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Modules\Users\Model\Publisher Clone of current object.
     * @throws PropelException
     */
    ...
    public function initBooks($overrideExisting = true)
    {
        ...
        $this->collBooks->setModel('\App\Modules\Auth\Model\Book');
    }
     ...
     * @return ObjectCollection|Book[] List of Book objects
     * @throws PropelException
     */
    ...
    /**
     * Returns the number of related BaseBook objects.
     *
     * @param      Criteria $criteria
     * @param      boolean $distinct
     * @param      ConnectionInterface $con
     * @return int             Count of related BaseBook objects.
     * @throws PropelException
     */
