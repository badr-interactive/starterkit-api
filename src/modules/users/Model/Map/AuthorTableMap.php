...
class AuthorTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'App.Modules.Users.Model.Map.AuthorTableMap';
     ...
     */
    const OM_CLASS = '\\App\\Modules\\Users\\Model\\Author';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'App.Modules.Users.Model.Author';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\App\\Modules\\Users\\Model\\Author');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\Modules\Users\Model\Author) { // it's a model object
