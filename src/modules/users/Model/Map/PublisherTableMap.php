...
namespace App\Modules\Users\Model\Map;
...
class PublisherTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'App.Modules.Users.Model.Map.PublisherTableMap';
     ...
     */
    const OM_CLASS = '\\App\\Modules\\Users\\Model\\Publisher';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'App.Modules.Users.Model.Publisher';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\App\\Modules\\Users\\Model\\Publisher');
        $this->setPackage('App.Modules.Users.Model');
    ...
    {
        $this->addRelation('Book', '\\App\\Modules\\Auth\\Model\\Book', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':publisher_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\Modules\Users\Model\Publisher) { // it's a model object
