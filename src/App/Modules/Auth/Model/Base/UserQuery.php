...
abstract class UserQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \App\Modules\Auth\Model\Base\UserQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'freedom', $modelName = '\\App\\Modules\\Auth\\Model\\User', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `id`, `uuid`, `email`, `password`, `last_login`, `created_at`, `updated_at` FROM `users` WHERE `id` = :p0';
        try {
